...
## Considerations for Creating Prompt Templates
Considerations for Creating Prompt TemplatesVarious considerations apply to creating prompt templates using field generation and flex types in Prompt Builder.❖NUMERICAL LIMITSPrompt templates have various numerical limits. For example, the maximum number of related list merge fields is 5.❖ACTIVITIES RELATED LISTThe Activities related list is not supported as a merge field on objects such as Account and Case since the relationship is polymorphic.❖USER RELATED LISTThe User and Organization related lists aren’t supported as merge fieldsdue to a limitation involving global variables.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5OTI3NTA4NzAsLTczODk4NDI0OSwtMT
