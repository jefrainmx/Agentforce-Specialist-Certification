...
### Prompt Template ActionA Prompt Template action can be added to a flow to generate a response using a prompt template.

## Scenarios & Solutions
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzNjQ3NDI2MywtMTEwNzgyNjc0Niw4OT
